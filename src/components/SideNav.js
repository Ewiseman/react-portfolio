...
const SideNav = () => {
  ...
  const NavLinkAnimation = (props) => {
    if (!isNavCollapsed) {
      return  (
        <Animated animationIn="fadeInLeft" animationInDuration={1000} animationInDelay={0} isVisible={true}>
    ...
    return (
      <div className="fancynavbar-addon"><a className="fancynavbar-addon-item" href="/#">yo</a></div>
    )
  }
