              ...
              <div className="col-lg-10 text-black text-center text-lg-left">
                ...
                >
                  ...
                  <div className="">
                    ...
                    >
                      <span className="text-underline font-weight-light">
                        Full-Stack
                      </span>
                      <br />
                      <span className="font-weight-light">Developer</span>
                    </h1>
                  </div>
                  <div className="">
                    <p
                      className="text-900 fs-0 mt-3 mt-md-5"
                      data-zanim-xs='{"delay":0.3}'
                    >
                      Creating data driven user experiences <br />
                      that wow and excite.
                    </p>
                  </div>
                  <div className="">
                    <div
                      className="d-lg-flex align-items-center font-weight-bold ls mt-3 mt-md-5 text-uppercase"
